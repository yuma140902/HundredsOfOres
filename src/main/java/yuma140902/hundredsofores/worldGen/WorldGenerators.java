...
public final class WorldGenerators {
	...
	public static void register() {
		GameRegistry.registerWorldGenerator(overWorldOreGenerator, WORLD_GENERATOR_PRIORITY);
...
//		GameRegistry.registerWorldGenerator(octahedronGenerator, WORLD_GENERATOR_PRIORITY);
	...
	public static final MyOverWorldOreGenerator overWorldOreGenerator = new MyOverWorldOreGenerator();
